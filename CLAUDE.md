...
build step, no virtual DOM. The product is *trust in a tiny core*: a 1.45 KB gz universal
...
tests/               # vitest + jsdom; mirrors src/ layout; 425 tests, 100% coverage enforced
...
```bash
npm run test          # vitest run (425 tests, ~seconds)
