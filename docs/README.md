...
> **Version:** <!-- lume:version -->2.3.1<!-- /lume:version --> · **Core:** <!-- lume:size-state -->1.46<!-- /lume:size-state --> KB gzipped (universal) / <!-- lume:size-index -->2.73<!-- /lume:size-index --> KB gzipped (+ DOM) · **Tests:** <!-- lume:tests -->466<!-- /lume:tests --> · **Dependencies:** 0
...
| Bundle size | <!-- lume:size-state -->1.46<!-- /lume:size-state -->–<!-- lume:size-index -->2.73<!-- /lume:size-index --> KB gzipped | 40 KB+ |
