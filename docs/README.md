...
> **Version:** <!-- lume:version -->2.3.1<!-- /lume:version --> · **Core:** <!-- lume:size-state -->1.46<!-- /lume:size-state --> KB gzipped (universal) / <!-- lume:size-index -->2.66<!-- /lume:size-index --> KB gzipped (+ DOM) · **Tests:** <!-- lume:tests -->477<!-- /lume:tests --> · **Dependencies:** 0
