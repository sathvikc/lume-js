export const DOCS_SITEMAP = [
  ...
  { slug: 'universal-core',       title: 'Universal core (Node, CLI, workers)', category: 'Guides',    file: 'docs/guides/universal-core.md' },
  { slug: 'choosing-reactive-primitives', title: 'Choosing reactive primitives', category: 'Guides', file: 'docs/guides/choosing-reactive-primitives.md' },
  ...
  { slug: 'api-batch',            title: 'batch()',              category: 'API — Core',      file: 'docs/api/core/batch.md' },
  ...
  { slug: 'api-persist',          title: 'persist()',            category: 'API — Addons',    file: 'docs/api/addons/persist.md' },
  { slug: 'api-cleanupGroup',     title: 'createCleanupGroup()', category: 'API — Addons',    file: 'docs/api/addons/createCleanupGroup.md' },
  { slug: 'api-hydrateState',     title: 'hydrateState()',       category: 'API — Addons',    file: 'docs/api/addons/hydrateState.md' },
  { slug: 'api-debug',            title: 'createDebugPlugin',    category: 'API — Addons',    file: 'docs/api/addons/debug.md' },
  { slug: 'api-plugins',          title: 'withPlugins()',        category: 'API — Addons',    file: 'docs/api/addons/withPlugins.md' },
  { slug: 'api-isReactive',       title: 'isReactive()',         category: 'API — Addons',    file: 'docs/api/addons/isReactive.md' },
  { slug: 'api-handlers',         title: 'Handlers API',         category: 'API — Handlers',  file: 'docs/api/core/handlers.md' },
  { slug: 'api-show',             title: 'show',                 category: 'API — Handlers',  file: 'docs/api/handlers/show.md' },
  { slug: 'api-className',        title: 'className',            category: 'API — Handlers',  file: 'docs/api/handlers/className.md' },
  { slug: 'api-boolAttr',         title: 'boolAttr',              category: 'API — Handlers',  file: 'docs/api/handlers/boolAttr.md' },
  { slug: 'api-ariaAttr',         title: 'ariaAttr',              category: 'API — Handlers',  file: 'docs/api/handlers/ariaAttr.md' },
  ...
  { slug: 'api-on',               title: 'on',                   category: 'API — Handlers',  file: 'docs/api/handlers/on.md' },
  { slug: 'api-htmlAttrs',        title: 'htmlAttrs',            category: 'API — Handlers',  file: 'docs/api/handlers/htmlAttrs.md' },
  ...
  { slug: 'tutorial-arrays',      title: 'Working with Arrays',  category: 'Tutorials',       file: 'docs/tutorials/working-with-arrays.md' },
