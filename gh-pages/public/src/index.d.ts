 ...
 *
 * Provides type safety for reactive state managemen
 */
 ...
 * @param store - Reactive state objec
 * @param options - Optional configuration
 * @returns Cleanup function to remove all bindings
 * @throws {Error} If root is not an HTMLElemen
 * @throws {Error} If store is not a reactive state objec
 *
 * @example
 * ```typescrip
 ...
 * @returns Cleanup function to stop the effec
